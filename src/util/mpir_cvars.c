 ...
 *   at:   Fri Jul 25 21:47:57 2025 UTC
 *
 * DO NOT EDIT!!!
 */
...
int MPIR_T_cvar_init(void)
{
    ...
    MPIR_T_cat_add_desc("PMI",
        "cvars that control behavior of the PMI interface");
    ...
    defaultval.d = 4;  /* default to 4 subcomms */
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_N_SUBCOMMS,               /* name */
        &MPIR_CVAR_N_SUBCOMMS,              /* address */
        1,                                       /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
        "COLLECTIVE",                            /* category */
"Number of subcommunicators used for pipelined GPU collectives.\n"
"Set to an integer to split GPU collectives across multiple communicators.\n"
"Default is 4. Can be tuned per platform for best performance.");
    MPIR_CVAR_N_SUBCOMMS = defaultval.d;
...
"ccl                      - Force CCL algorithm");
    ...
    if (tmp_str != NULL) {
        ...
        else if (0 == strcmp(tmp_str, "ccl"))
            MPIR_CVAR_ALLREDUCE_INTRA_ALGORITHM = MPIR_CVAR_ALLREDUCE_INTRA_ALGORITHM_ccl;
        else {
    ...
    defaultval.d = MPIR_CVAR_ALLREDUCE_CCL_auto;
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_ALLREDUCE_CCL, /* name */
        &MPIR_CVAR_ALLREDUCE_CCL, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
...
"nccl - Force NCCL\n"
"rccl - Force RCCL");
    MPIR_CVAR_ALLREDUCE_CCL = defaultval.d;
    tmp_str=NULL;
    got_rc = 0;
    rc = MPL_env2str("MPICH_ALLREDUCE_CCL", &tmp_str);
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_CCL");
    got_rc += rc;
    rc = MPL_env2str("MPIR_PARAM_ALLREDUCE_CCL", &tmp_str);
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_PARAM_ALLREDUCE_CCL");
    got_rc += rc;
    rc = MPL_env2str("MPIR_CVAR_ALLREDUCE_CCL", &tmp_str);
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_ALLREDUCE_CCL");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_ALLREDUCE_CCL = %s\n", tmp_str);
    }
    if (tmp_str != NULL) {
        if (0 == strcmp(tmp_str, "auto"))
            MPIR_CVAR_ALLREDUCE_CCL = MPIR_CVAR_ALLREDUCE_CCL_auto;
        else if (0 == strcmp(tmp_str, "nccl"))
            MPIR_CVAR_ALLREDUCE_CCL = MPIR_CVAR_ALLREDUCE_CCL_nccl;
        else if (0 == strcmp(tmp_str, "rccl"))
            MPIR_CVAR_ALLREDUCE_CCL = MPIR_CVAR_ALLREDUCE_CCL_rccl;
        else {
            mpi_errno = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, __func__, __LINE__,MPI_ERR_OTHER, "**cvar_val", "**cvar_val %s %s", "MPIR_CVAR_ALLREDUCE_CCL", tmp_str);
            goto fn_fail;
        }
    }
...
"x        - PMIx");
    ...
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_PMI_DISABLE_GROUP, /* name */
        &MPIR_CVAR_PMI_DISABLE_GROUP, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
    ...
    MPIR_CVAR_PMI_DISABLE_GROUP = defaultval.d;
    got_rc = 0;
    rc = MPL_env2bool("MPICH_PMI_DISABLE_GROUP", &(MPIR_CVAR_PMI_DISABLE_GROUP));
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_PMI_DISABLE_GROUP");
    got_rc += rc;
    rc = MPL_env2bool("MPIR_PARAM_PMI_DISABLE_GROUP", &(MPIR_CVAR_PMI_DISABLE_GROUP));
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_PARAM_PMI_DISABLE_GROUP");
    got_rc += rc;
    rc = MPL_env2bool("MPIR_CVAR_PMI_DISABLE_GROUP", &(MPIR_CVAR_PMI_DISABLE_GROUP));
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_PMI_DISABLE_GROUP");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_PMI_DISABLE_GROUP = %d\n", MPIR_CVAR_PMI_DISABLE_GROUP);
    }
    ...
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_PROGRESS_TIMEOUT, /* name */
        &MPIR_CVAR_PROGRESS_TIMEOUT, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_LOCAL,
        defaultval,
    ...
    MPIR_CVAR_PROGRESS_TIMEOUT = defaultval.d;
    got_rc = 0;
    rc = MPL_env2int("MPICH_DEBUG_PROGRESS_TIMEOUT", &(MPIR_CVAR_PROGRESS_TIMEOUT));
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_DEBUG_PROGRESS_TIMEOUT");
    got_rc += rc;
    rc = MPL_env2int("MPIR_PARAM_DEBUG_PROGRESS_TIMEOUT", &(MPIR_CVAR_PROGRESS_TIMEOUT));
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_PARAM_DEBUG_PROGRESS_TIMEOUT");
    got_rc += rc;
    rc = MPL_env2int("MPIR_CVAR_DEBUG_PROGRESS_TIMEOUT", &(MPIR_CVAR_PROGRESS_TIMEOUT));
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_DEBUG_PROGRESS_TIMEOUT");
    got_rc += rc;
    rc = MPL_env2int("MPICH_PROGRESS_TIMEOUT", &(MPIR_CVAR_PROGRESS_TIMEOUT));
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_PROGRESS_TIMEOUT");
    got_rc += rc;
    rc = MPL_env2int("MPIR_PARAM_PROGRESS_TIMEOUT", &(MPIR_CVAR_PROGRESS_TIMEOUT));
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_PARAM_PROGRESS_TIMEOUT");
    got_rc += rc;
    rc = MPL_env2int("MPIR_CVAR_PROGRESS_TIMEOUT", &(MPIR_CVAR_PROGRESS_TIMEOUT));
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_PROGRESS_TIMEOUT");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_PROGRESS_TIMEOUT = %d\n", MPIR_CVAR_PROGRESS_TIMEOUT);
    }
